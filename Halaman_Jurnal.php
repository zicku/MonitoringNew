                                        ...
                                        <div class="form-row">
                                            <div class="form-group col-md-6">
                                                ...
                                                <select class="form-control" id="sortingFilter" name="sorting">
                                                    <option value="none" <?php echo (!isset($_GET['sorting']) || $_GET['sorting'] == 'none') ? 'selected' : ''; ?>>None
                                                    </option>
                                                    <option value="name" <?php echo (isset($_GET['sorting']) && $_GET['sorting'] == 'name') ? 'selected' : ''; ?>>Nama
                                                    </option>
                                                    <option value="indeks" <?php echo (isset($_GET['sorting']) && $_GET['sorting'] == 'indeks') ? 'selected' : ''; ?>>Indeks
                                                    </option>
                                                    <option value="volume" <?php echo (isset($_GET['sorting']) && $_GET['sorting'] == 'volume') ? 'selected' : ''; ?>>Volume
                                                        Terbaru</option>
                                                </select>
                                            </div>
                                            <div class="form-group col-md-6">
                                                ...
                                                <input type="text" class="form-control" id="keywordSearch"
                                                    name="keyword" placeholder="Enter Journal Name..."
                                        ...
                                        <table class="table" id="table-1">
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td><a class="nama_jurnal"
                                                            href="<?php echo $data['link_jurnal']; ?>"><?php echo $data['nama_jurnal']; ?></a>
                                                    </td>
                                                    <td><a class="indeks_jurnal"
                                                            href="<?php echo $data['link_indeks']; ?>"><?php echo $data['indeks_jurnal']; ?></a>
                                                        <br>
